<?php
namespace Flow\WebSocket\Service;
...
use Flow\WebSocket\Domain\Model\Client;
...
class ListenerService {
	 ...
	 */
	function ListenerService($address = '127.0.0.1', $port = 5003, $verboseMode = false) {
